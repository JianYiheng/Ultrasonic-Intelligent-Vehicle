...
Sonic_echo prog2(clk, echo[0], text1,text1_out);
Sonic_trig prog3(clk, trig[1]);
Sonic_echo prog4(clk, echo[1], text2,text2_out);
Sonic_trig prog5(clk, trig[2]);
Sonic_echo prog6(clk, echo[2], text3,text3_out);
...
led_seg prog12(clk, text2_out, text3_out, post1, post2, seg1, seg2);
